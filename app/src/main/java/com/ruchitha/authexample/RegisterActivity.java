...
FirebaseAuth auth;
    ...
    if(umail.isEmpty()| upass.isEmpty()){
        Toast.makeText(this, "Fill all the required details", Toast.LENGTH_SHORT).show();
    }
    else if(upass.length()<6){
        Toast.makeText(this, "Password should be a minimum of six characters", Toast.LENGTH_SHORT).show();
    }
    else {
